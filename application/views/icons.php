			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="<?=base_url()?>icons.html" class="active"><i class="lnr lnr-linearicons"></i> <span>Icons</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline demo-icons">
						<div class="panel-heading">
							...
							<p class="subtitle">For complete list, please visit <a href="<?=base_url()?>https://linearicons.com/free" target="_blank">https://linearicons.com/free</a></p>
						</div>
					...
					<div class="panel panel-headline demo-icons">
						<div class="panel-heading">
							...
							<p class="subtitle">For complete list, please visit <a href="<?=base_url()?>http://fontawesome.io/icons/" target="_blank">http://fontawesome.io/icons/</a></p>
						</div>
						<div class="panel-body">
							<ul class="list-unstyled row">
								<li class="col-md-2 col-sm-4 col-xs-6">
